...
class UNetExperiment:
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # 
            data = batch['image'].float()#.to(self.device, dtype=torch.float)#<YOUR CODE HERE>
            target = batch['seg']#.to(self.device)#<YOUR CODE HERE>
